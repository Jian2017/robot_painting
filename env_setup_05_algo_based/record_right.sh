...
lerobot-record \
  ...
  --dataset.repo_id=local/algo_right \
  --dataset.root=/Users/jian/workspace/robot_painting/env_setup_05_algo_based/datasets_right \
  --dataset.single_task="move arm to right" \
